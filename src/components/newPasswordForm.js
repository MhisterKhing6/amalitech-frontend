                ...
                <div>
                    <form className="p-2" onSubmit={async (e) => {
                       ...
                       let url = "/auth/user/update-password"
                        ...
                        let response = await postToBackend(url, {password:pwd, verificationId})
                        ...
                        if(response.status !== 200) {
                            ...
                            redirect("/user/congratulations/new-password", {state: {loginUrl: loginUrl ? loginUrl:'/auth/login/customer'}})
                        }
                        //enable button
                        setSubmitted(false)
                        setSpiner(false)
